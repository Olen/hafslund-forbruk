...
exports.cachePath = config.cachePath;
...
function cachedResource (httpResponse) {
	...
	this.getContents = function () {
		...
		// console.log("Cachefile: " + exports.cachePath+this.cacheFile);
		...
		var contentStart = contents.indexOf("\0PK") + 1;
		return contents.substr(contentStart);
